...
| GET    | `/api/business?page=0&size=10`  | All businesses (paged)  |
...
| GET    | `/api/products?page=0&size=10`  | All products (paged) |
...
| Method | Endpoint                               | Description                     |
|--------|----------------------------------------|---------------------------------|
| POST   | `/api/invoices`                        | Create invoice (auto GST calc)  |
| GET    | `/api/invoices/{id}`                   | Get invoice with line items     |
| GET    | `/api/invoices?page=0&size=10`         | All invoices (paginated)        |
| GET    | `/api/invoices/business/{businessId}`  | Invoices for a business         |
